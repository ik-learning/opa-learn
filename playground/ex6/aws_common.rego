...
required_resources := ["aws_s3_account_public_access_block"]

denied_resources := ["aws_secretsmanager_secret_version"]
...
deny["Missing aws_s3_account_public_access_block resource"] {
	...
	msg := sprintf("Missing required resource %v", [required_resources[i]])
}
